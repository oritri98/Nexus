...
new_html = """                <div class="armory-segments">
                        ...
                        <div class="armory-segment">
                            ...
                            <div class="segment-grid">
                                <div class="showcase-card glass-panel">
                                    ...
                                    <div class="showcase-header"><h3>Minimize Windows</h3></div>
                                ...
                                <div class="showcase-card glass-panel">
                                    ...
                                    <div class="split-visuals">
                                        <div class="visual-pane hand-pane"><span class="pane-label">HAND</span><div class="visual-placeholder"><div class="palm-shape"><div class="palm-shape-inner"></div><div class="palm-shape-thumb"></div></div></div></div>
                                ...
                                <div class="showcase-card glass-panel">
                                    ...
                                    <div class="split-visuals">
                                        <div class="visual-pane hand-pane"><span class="pane-label">HAND</span><div class="visual-placeholder"><div class="thumb-up-shape"></div></div></div>
                                        <div class="visual-pane screen-pane"><span class="pane-label">SCREEN</span><div class="visual-placeholder loop-vol"><div class="vol-slider-mock"><div class="vol-fill"></div></div></div></div>
                                    </div>
                                </div>
                                <div class="showcase-card glass-panel">
                                    ...
                                    <div class="split-visuals">
                                        <div class="visual-pane hand-pane"><span class="pane-label">HAND</span><div class="visual-placeholder"><div class="thumb-down-shape"></div></div></div>
                                        <div class="visual-pane screen-pane"><span class="pane-label">SCREEN</span><div class="visual-placeholder loop-vol loop-vol-down"><div class="vol-slider-mock"><div class="vol-fill"></div></div></div></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="armory-segment">
                            ...
                            <div class="segment-grid">
                                ...
                                <div class="showcase-card glass-panel">
                                    ...
                                    <div class="split-visuals">
                                        <div class="visual-pane hand-pane"><span class="pane-label">HAND</span><div class="visual-placeholder loop-pinch-pinky"><div class="hand-shape-pinky"></div></div></div>
                                        <div class="visual-pane screen-pane"><span class="pane-label">SCREEN</span><div class="visual-placeholder loop-menu"><div class="mock-menu"><div class="menu-line"></div><div class="menu-line"></div><div class="menu-line"></div></div><div class="mock-cursor" style="left:40px;top:40px;"></div></div></div>
                                    </div>
                                </div>
                                <div class="showcase-card glass-panel">
                                    ...
                                    <div class="split-visuals">
                                        <div class="visual-pane hand-pane"><span class="pane-label">HAND</span><div class="visual-placeholder loop-drag-pinky"><div class="hand-shape-pinky"></div><div class="pinch-dot"></div></div></div>
                                        <div class="visual-pane screen-pane"><span class="pane-label">SCREEN</span><div class="visual-placeholder loop-click"><div class="mock-cursor"></div><div class="mock-file"></div></div></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- Bottom Row -->
                    <div class="armory-bottom-row flowchart-container">
                        <div class="flow-step">
                            <div class="armory-segment" style="width:100%;">
                                <h3 class="segment-title" style="margin-bottom:10px;">Two-Handed Gestures (Scroll Mode)</h3>
                                <div class="showcase-card glass-panel flow-card">
                                    ...
                                    <div class="showcase-header" style="justify-content:center;"><h3>Enter Scroll Mode</h3></div>
                                    <div class="split-visuals">
                        ...
                        <div class="flow-arrow">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="var(--accent-cyan)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="flow-step">
                            <div class="showcase-card glass-panel flow-card">
                                ...
                                <div class="showcase-header" style="justify-content:center;"><h3>Exit Scroll Mode</h3></div>
                                <div class="split-visuals">
...
pattern = re.compile(r'<div class="armory-segments">.*?</div>\s*</div>\s*</div>\s*</div>', re.DOTALL)
